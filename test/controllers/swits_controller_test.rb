...
class SwitsControllerTest < ActionController::TestCase
  ...
  test "should create swit" do
    assert_difference('Swit.count') do
      post :create, swit: { message: @swit.message, sour: @swit.sour, sweet: @swit.sweet, user_id: @swit.user_id }
    end
  ...
  test "should update swit" do
    patch :update, id: @swit, swit: { message: @swit.message, sour: @swit.sour, sweet: @swit.sweet, user_id: @swit.user_id }
    assert_redirected_to swit_path(assigns(:swit))
  end
